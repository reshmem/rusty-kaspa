...
use igra_core::model::{EventSource, PartialSigRecord, RequestDecision, SigningEvent, SigningRequest, StoredProposal};
...
#[tokio::test]
async fn coordinator_times_out_with_partial_responses() {
