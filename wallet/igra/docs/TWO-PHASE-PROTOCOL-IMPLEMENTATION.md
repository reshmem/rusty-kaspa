# TWO-PHASE-PROTOCOL-IMPLEMENTATION.md

Step-by-step implementation plan for the Two-Phase UTXO Consensus Protocol.

This plan follows CODE-GUIDELINE.md and implements TWO-PHASE-PROTOCOL.md specification v1.1.
...
*Based on: TWO-PHASE-PROTOCOL.md v1.1*
