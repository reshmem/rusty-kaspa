...
#[test]
fn test_storage_rocks_when_roundtrip_then_persists_and_tracks_volume() {
...
#[test]
fn test_storage_rocks_when_group_config_roundtrip_then_loads() {
    let temp_dir = TempDir::new().expect("temp dir");
    let storage = RocksStorage::open_in_dir(temp_dir.path()).expect("open rocksdb");
...
#[test]
fn test_storage_rocks_when_checkpoint_roundtrip_then_restores() {
    let temp_dir = TempDir::new().expect("temp dir");
    let storage = RocksStorage::open_in_dir(temp_dir.path()).expect("open rocksdb");
