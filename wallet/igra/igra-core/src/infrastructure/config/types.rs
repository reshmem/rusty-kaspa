...
impl RuntimeConfig {
    fn merge_from(&mut self, other: &RuntimeConfig) {
        ...
        if other.session_expiry_seconds.is_some() {
            self.session_expiry_seconds = other.session_expiry_seconds;
        }
    }
}
...
impl HyperlaneConfig {
    fn merge_from(&mut self, other: &HyperlaneConfig) {
        ...
        if other.default_derivation_path.is_some() {
            self.default_derivation_path = other.default_derivation_path.clone();
        }
